//[Mã câu hỏi (qCode): 4h1Bc5Lh].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để quản lý thông tin đơn hàng trong hệ thống thương mại điện tử. Chương trình sẽ ngẫu nhiên tạo ra đối tượng Order với các giá trị ban đầu và cung cấp cho RMI client như sau:
//    Giao diện từ xa:
...
public class CapNhatOrderCodecuaOrder {
    public static void main(String[] args) throws Exception{
        String studentCode = "B21DCCN014",qCode = "4h1Bc5Lh";
        Registry rg = LocateRegistry.getRegistry("203.162.10.109");
        ObjectService sv = (ObjectService) rg.lookup("RMIObjectService");
        Order a = (Order) sv.requestObject(studentCode, qCode);
        System.out.println(a);
        String cc = a.getCustomerCode(); int n = cc.length();
        String giua = cc.substring(n-3, n);
