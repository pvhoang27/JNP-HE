//[Mã câu hỏi (qCode): fNxEWaEh].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý chuỗi.
//Giao diện từ xa:
...
public class DemTanSuatKiTu2 {
    public static void main(String[] args) throws Exception{
        String studentCode = "B21DCCN014" , qCode = "fNxEWaEh";
