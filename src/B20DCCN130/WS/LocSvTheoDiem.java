//[Mã câu hỏi (qCode): IhxSzqzi].  Một dịch vụ web (hỗ trợ SOAP version 1.1) được định nghĩa và mô tả trong tệp ObjectService.wsdl, được triển khai trên server tại URL http://<Exam_IP>:8080/JNPWS/ObjectService?wsdl để xử lý các bài toán với đối tượng.
...
public class LocSvTheoDiem {
    public static void main(String[] args) throws Exception{
        String studentCode ="B20DCCN130",qCode = "IhxSzqzi";
        ...
        for(Student s : a){
            ...
            if(score >= 8.0 || score < 5.0) kq.add(s);
        }
